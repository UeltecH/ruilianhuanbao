var city = {
		'北京': {
			'北京': ['东城区', '西城区', '崇文区', '宣武区', '朝阳区', '丰台区', '石景山区', '海淀区', '门头沟区', '房山区', '通州区', '顺义区', '昌平区', '大兴区', '平谷区',
				'怀柔区', '密云县', '延庆县', '其他'
			]
		},
		'天津': {
			'天津': ['和平区', '河东区', '河西区', '南开区', '河北区', '红挢区', '滨海新区', '东丽区', '西青区', '津南区', '北辰区', '宁河区', '武清区', '静海县', '宝坻区',
				'蓟县', '塘沽区', '汉沽区', '大港区', '宝坻区', '其他'
			]
		},
		'河北': {
			'石家庄': ['长安区', '桥东区', '桥西区', '新华区', '井陉矿区', '裕华区', '井陉县', '正定县', '栾城县', '行唐县', '灵寿县', '高邑县', '深泽县', '赞皇县', '无极县',
				'平山县', '元氏县', '赵县', '辛集市', '藁城市', '晋州市', '新乐市', '鹿泉市', '其他'
			],
			'唐山': ['路南区', '路北区', '古冶区', '开平区', '丰南区', '丰润区', '滦县', '滦南县', '乐亭县', '迁西县', '玉田县', '唐海县', '遵化市', '迁安市', ' 曹妃甸区',
				'其他'
			],
			'秦皇岛': ['海港区', '山海关区', '北戴河区', '青龙满族自治县', '昌黎县', '抚宁县', '卢龙县', '其他'],
			'邯郸': ['邯山区', '丛台区', '复兴区', '峰峰矿区', '邯郸县', '临漳县', '成安县', '大名县', '涉县', '磁县', '肥乡县', '永年县', '邱县', '鸡泽县', '广平县', '馆陶县',
				'魏县', '曲周县', '武安市', '其他'
			],
			'邢台': ['桥东区', '桥西区', '邢台县', '临城县', '内丘县', '柏乡县', '隆尧县', '任县', '南和县', '宁晋县', '巨鹿县', '新河县', '广宗县', '平乡县', '威县', '清河县',
				'临西县', '南宫市', '沙河市', '其他'
			],
			'保定': ['新市区', '北市区', '南市区', '满城县', '清苑县', '涞水县', '阜平县', '徐水县', '定兴县', '唐县', '高阳县', '容城县', '涞源县', '望都县', '安新县', '易县',
				'曲阳县', '蠡县', '顺平县', '博野县', '雄县', '涿州市', '定州市', '安国市', '高碑店市', '其他'
			],
			'张家口': ['桥东区', '桥西区', '宣化区', '下花园区', '宣化县', '张北县', '康保县', '沽源县', '尚义县', '蔚县', '阳原县', '怀安县', '万全县', '怀来县', '涿鹿县',
				'赤城县', '崇礼县', '其他'
			],
			'承德': ['双桥区', '双滦区', '鹰手营子矿区', '承德县', '兴隆县', '平泉县', '滦平县', '隆化县', '丰宁满族自治县', '宽城满族自治县', '围场满族蒙古族自治县', '其他'],
			'沧州': ['新华区', '运河区', '沧县', '青县', '东光县', '海兴县', '盐山县', '肃宁县', '南皮县', '吴桥县', '献县', '孟村回族自治县', '泊头市', '任丘市', '黄骅市',
				'河间市', '其他'
			],
		...
		'山西': {
			...
			'临汾': ['尧都区', '曲沃县', '翼城县', '襄汾县', '洪洞县', '古县', '安泽县', '浮山县', '吉县', '乡宁县', '大宁县', '隰县', '永和县', '蒲县', '汾西县', '侯马市',
				'霍州市', '其他'
			],
		...
		'内蒙古': {
			...
			'呼伦贝尔': ['海拉尔区', '扎赉诺尔', '阿荣旗', '莫力达瓦达斡尔族自治旗', '鄂伦春自治旗', '鄂温克族自治旗', '陈巴尔虎旗', '新巴尔虎左旗', '新巴尔虎右旗', '满洲里市', '牙克石市',
				'扎兰屯市', '额尔古纳市', '根河市', '其他'
			],
		...
		'黑龙江': {
			'哈尔滨': ['道里区', '南岗区', '道外区', '平房区', '松北区', '香坊区', '呼兰区', '阿城区', '依兰县', '方正县', '宾县', '巴彦县', '木兰县', '通河县', '延寿县',
				'双城市', '尚志市', '五常市', '其他'
			],
			'齐齐哈尔': ['龙沙区', '建华区', '铁锋区', '昂昂溪区', '富拉尔基区', '碾子山区', '梅里斯达斡尔族区', '龙江县', '依安县', '泰来县', '甘南县', '富裕县', '克山县', '克东县',
				'拜泉县', '讷河市', '其他'
			],
			...
			'伊春': ['伊春区', '南岔区', '友好区', '西林区', '翠峦区', '新青区', '美溪区', '金山屯区', '五营区', '乌马河区', '汤旺河区', '带岭区', '乌伊岭区', '红星区', '上甘岭区',
				'嘉荫县', '铁力市', '其他'
			],
		...
		'上海': {
			'上海': ['黄浦区', '卢湾区', '徐汇区', '长宁区', '静安区', '普陀区', '闸北区', '虹口区', '杨浦区', '闵行区', '宝山区', '嘉定区', '浦东新区', '金山区', '松江区',
				'奉贤区', '青浦区', '奉贤区', '崇明县', '其他'
			]
		},
		'江苏': {
		...
		'江西': {
			...
			'新余': ['渝水区', '分宜县', '其他'],
			'鹰潭': ['月湖区', '余江县', '贵溪市', '其他'],
			'赣州': ['章贡区', '赣县', '信丰县', '大余县', '上犹县', '崇义县', '安远县', '龙南县', '定南县', '全南县', '宁都县', '于都县', '兴国县', '会昌县', '寻乌县', '石城县',
				'瑞金市', '南康市', '其他'
			],
		...
		'河南': {
			...
			'洛阳': ['老城区', '西工区', '廛河回族区', '涧西区', '吉利区', '洛龙区', '孟津县', '新安县', '栾川县', '嵩县', '汝阳县', '宜阳县', '洛宁县', '伊川县', '偃师市',
				'其他'
			],
			...
			'济源': ['沁园街道', '济水街道', '北海街道', '天坛街道', '玉泉街道', '克井镇', '五龙口镇', '轵城镇', '承留镇', '邵原镇', '坡头镇', '梨林镇', '大峪镇', '思礼镇', '王屋镇',
				'下冶镇', '其他'
			]
		},
		'湖北': {
			...
			'仙桃': ['沙嘴街道', '干河街道', '龙华山办事处', '郑场镇', '毛嘴镇', '豆河镇', '三伏潭镇', '胡场镇', '长倘口镇', '西流河镇', '沙湖镇', '杨林尾镇', '彭场镇', '张沟镇',
				'郭河镇', '沔城回族镇', '通海口镇', '陈场镇', '工业园区', '九合垸原种场', '沙湖原种场', '五湖渔场', '赵西垸林场', '畜禽良种场', '排湖风景区', '其他'
			],
			'潜江': ['园林办事处', '杨市办事处', '周矶办事处', '广华办事处', '泰丰办事处', '高场办事处', '竹根滩镇', '渔洋镇', '王场镇', '高石碑镇', '熊口镇', '老新镇', '浩口镇',
				'积玉口镇', '张金镇', '龙湾镇', '江汉石油管理局', '潜江经济开发区', '周矶管理区', '后湖管理区', '熊口管理区', '总口管理区', '白鹭湖管理区', '运粮湖管理区', '浩口原种场', '其他'
			],
			'天门': ['竟陵街道', '侨乡街道开发区', '杨林街道', '多宝镇', '拖市镇', '张港镇', '蒋场镇', '汪场镇', '渔薪镇', '黄潭镇', '岳口镇', '横林镇', '彭市镇', '麻洋镇', '多祥镇',
				'干驿镇', '马湾镇', '卢市镇', '小板镇', '九真镇', '皂市镇', '胡市镇', '石河镇', '佛子山镇', '净潭乡', '蒋湖农场', '白茅湖农场', '沉湖管委会', '其他'
			],
		...
		'广东': {
			...
			'东莞': ['东城街道', '南城街道', '万江街道', '莞城街道', '石碣镇', '石龙镇', '茶山镇', '石排镇', '企石镇', '横沥镇', '桥头镇', '谢岗镇', '东坑镇', '常平镇', '寮步镇',
				'樟木头镇', '大朗镇', '黄江镇', '清溪镇', '塘厦镇', '凤岗镇', '大岭山镇', '长安镇', '虎门镇', '厚街镇', '沙田镇', '道滘镇', '洪梅镇', '麻涌镇', '望牛墩镇', '中堂镇',
				'高埗镇', '松山湖管委会', '虎门港管委会', '东莞生态园', '其他'
			],
			'中山': ['石岐区街道', '东区街道', '火炬开发区街道', '西区街道', '南区街道', '五桂山街道', '小榄镇', '黄圃镇', '民众镇', '东凤镇', '东升镇', '古镇镇', '沙溪镇', '坦洲镇',
				'港口镇', '三角镇', '横栏镇', '南头镇', '阜沙镇', '南朗镇', '三乡镇', '板芙镇', '大涌镇', '神湾镇', '其他'
			],
			'潮州': ['湘桥区', '潮安县', '饶平县', '其他'],
		...
		'广西': {
			...
			'桂林': ['秀峰区', '叠彩区', '象山区', '七星区', '雁山区', '阳朔县', '临桂县', '灵川县', '全州县', '兴安县', '永福县', '灌阳县', '龙胜各族自治县', '资源县', '平乐县',
				'荔蒲县', '恭城瑶族自治县', '其他'
			],
		...
		'海南': {
			...
			'琼海': ['嘉积镇', '万泉镇', '石壁镇', '中原镇', '博鳌镇', '阳江镇', '龙江镇', '潭门镇', '塔洋镇', '长坡镇', '大路镇', '会山镇', '国营东太农场', '国营东红农场',
				'国营东升农场', '彬村山华侨农场', '其他'
			],
			'儋州': ['那大镇', '和庆镇', '南丰镇', '大成镇', '雅星镇', '兰洋镇', '光村镇', '木棠镇', '海头镇', '峨蔓镇', '三都镇', '王五镇', '白马井镇', '中和镇', '排浦镇',
				'东成镇', '新州镇', '国营西培农场', '国营西联农场', '国营蓝洋农场', '国营八一农场', '洋浦经济开发区', '华南热作学院', '其他'
			],
			'文昌': ['文城镇', '重兴镇', '蓬莱镇', '会文镇', '东路镇', '潭牛镇', '东阁镇', '文教镇', '东郊镇', '龙楼镇', '昌洒镇', '翁田镇', '抱罗镇', '冯坡镇', '锦山镇',
				'铺前镇', '公坡镇', '国营东路农场', '国营南阳农场', '国营罗豆农场', '其他'
			],
			'万宁': ['万城镇', '龙滚镇', '和乐镇', '后安镇', '大茂镇', '东澳镇', '礼纪镇', '长丰镇', '山根镇', '北大镇', '南桥镇', '三更罗镇', '国营东兴农场', '国营东和农场',
				'国营新中农场', '兴隆华侨农场', '地方国营六连林场', '其他'
			],
			...
			'澄迈': ['金江镇', '老城镇', '瑞溪镇', '永发镇', '加乐镇', '文儒镇', '中兴镇', '仁兴镇', '福山镇', '桥头镇', '大丰镇', '国营红光农场', '国营西达农场', '国营金安农场',
				'其他'
			],
			'临高': ['临城镇', '波莲镇', '东英镇', '博厚镇', '皇桐镇', '多文镇', '和舍镇', '南宝镇', '新盈镇', '调楼镇', '国营红华农场', '国营加来农场', '其他'],
			'白沙': ['牙叉镇', '七坊镇', '邦溪镇', '打安镇', '细水乡', '元门乡', '南开乡', '阜龙乡', '青松乡', '金波乡', '荣邦乡', '国营白沙农场', '国营龙江农场', '国营邦溪农场',
				'其他'
			],
			'昌江': ['石碌镇', '叉河镇', '十月田镇', '乌烈镇', '昌化镇', '海尾镇', '七叉镇', '王下乡', '国营红林农场', '国营霸王岭林场', '海南矿业联合有限公司', '其他'],
			'乐东': ['抱由镇', '万冲镇', '大安镇', '志仲镇', '千家镇', '九所镇', '利国镇', '黄流镇', '佛罗镇', '尖峰镇', '莺歌海镇', '国营山荣农场', '国营乐光农场', '国营保国农场',
				'国营尖峰岭林业公司', '国营莺歌海盐场', '其他'
			],
			'陵水': ['椰林镇', '光坡镇', '三才镇', '英州镇', '隆广镇', '文罗镇', '本号镇', '新村镇', '黎安镇', '提蒙乡', '群英乡', '国营岭门农场', '国营南平农场', '国营吊罗山林业公司',
				'其他'
			],
			'保亭': ['保城镇', '什玲镇', '加茂镇', '响水镇', '新政镇', '三道镇', '六弓乡', '南林乡', '毛感乡', '国营新星农场', '海南保亭热带作物研究所', '国营金江农场', '国营三道农场',
				'其他'
			],
			'琼中': ['营根镇', '湾岭镇', '黎母山镇', '和平镇', '长征镇', '红毛镇', '中平镇', '吊罗山乡', '上安乡', '什运乡', '国营阳江农场', '国营乌石农场', '国营加钗农场',
				'国营长征农场', '国营黎母山林业公司', '其他'
			],
		},
		'重庆': {
			'重庆': ['万州区', '涪陵区', '渝中区', '大渡口区', '江北区', '沙坪坝区', '九龙坡区', '南岸区', '北碚区', '万盛区', '双挢区', '渝北区', '巴南区', '长寿区', '綦江县',
				'潼南县', '铜梁县', '大足县', '荣昌县', '壁山县', '梁平县', '城口县', '丰都县', '垫江县', '武隆县', '忠县', '开县', '云阳县', '奉节县', '巫山县', '巫溪县',
				'黔江区', '石柱土家族自治县', '秀山土家族苗族自治县', '酉阳土家族苗族自治县', '彭水苗族土家族自治县', '江津区', '合川区', '永川区', '南川区', '其他'
			]
		},
		'四川': {
			'成都': ['锦江区', '青羊区', '金牛区', '武侯区', '成华区', '龙泉驿区', '青白江区', '新都区', '温江区', '金堂县', '双流县', '郫县', '大邑县', '蒲江县', '新津县',
				'都江堰市', '彭州市', '邛崃市', '崇州市', '其他'
			],
			...
			'甘孜': ['康定县', '泸定县', '丹巴县', '九龙县', '雅江县', '道孚县', '炉霍县', '甘孜县', '新龙县', '德格县', '白玉县', '石渠县', '色达县', '理塘县', '巴塘县',
				'乡城县', '稻城县', '得荣县', '其他'
			],
			'凉山': ['西昌市', '木里藏族自治县', '盐源县', '德昌县', '会理县', '会东县', '宁南县', '普格县', '布拖县', '金阳县', '昭觉县', '喜德县', '冕宁县', '越西县', '甘洛县',
				'美姑县', '雷波县', '其他'
			]
		},
		'贵州': {
			...
			'遵义': ['红花岗区', '汇川区', '遵义县', '桐梓县', '绥阳县', '正安县', '道真仡佬族苗族自治县', '务川仡佬族苗族自治县', '凤冈县', '湄潭县', '余庆县', '习水县', '赤水市',
				'仁怀市', '其他'
			],
			...
			'黔东南': ['凯里市', '黄平县', '施秉县', '三穗县', '镇远县', '岑巩县', '天柱县', '锦屏县', '剑河县', '台江县', '黎平县', '榕江县', '从江县', '雷山县', '麻江县',
				'丹寨县', '其他'
			],
			'黔南': ['都匀市', '福泉市', '荔波县', '贵定县', '瓮安县', '独山县', '平塘县', '罗甸县', '长顺县', '龙里县', '惠水县', '三都水族自治县', '其他']
		},
		'云南': {
			'昆明': ['五华区', '盘龙区', '官渡区', '西山区', '东川区', '呈贡县', '晋宁县', '富民县', '宜良县', '石林彝族自治县', '嵩明县', '禄劝彝族苗族自治县', '寻甸回族彝族自治县',
				'安宁市', '其他'
			],
			...
			'普洱': ['思茅区', '宁洱镇', '墨江哈尼族自治县', '景东彝族自治县', '景谷傣族彝族自治县', '镇沅彝族哈尼族拉祜族自治县', '江城哈尼族彝族自治县', '孟连傣族拉祜族佤族自治县', '澜沧拉祜族自治县',
				'西盟佤族自治县', '其他'
			],
			'临沧': ['临翔区', '凤庆县', '云县', '永德县', '镇康县', '双江拉祜族佤族布朗族傣族自治县', '耿马傣族佤族自治县', '沧源佤族自治县', '其他'],
			'楚雄': ['楚雄市', '双柏县', '牟定县', '南华县', '姚安县', '大姚县', '永仁县', '元谋县', '武定县', '禄丰县', '其他'],
			'红河': ['个旧市', '开远市', '蒙自县', '屏边苗族自治县', '建水县', '石屏县', '弥勒县', '泸西县', '元阳县', '红河县', '金平苗族瑶族傣族自治县', '绿春县', '河口瑶族自治县',
				'其他'
			],
		...
		'西藏': {
			...
			'日喀则': ['日喀则市', '南木林县', '江孜县', '定日县', '萨迦县', '拉孜县', '昂仁县', '谢通门县', '白朗县', '仁布县', '康马县', '定结县', '仲巴县', '亚东县', '吉隆县',
				'聂拉木县', '萨嘎县', '岗巴县', '其他'
			],
		...
		'新疆': {
			...
			'阿拉尔': ['金银川路街道', '幸福路街道', '青松路街道', '南口街道', '托喀依乡工业园区', '兵团七团', '兵团八团', '兵团十团', '兵团十一团', '兵团十二团', '兵团十三团', '兵团十四团',
				'兵团十六团', '兵团第一师水利水电工程处', '兵团第一师塔里木灌区水利管理处', '阿拉尔农场', '兵团第一师幸福农场', '中心监狱', '其他'
			],
			'图木舒克': ['齐干却勒街道', '前海街道', '永安坝街道', '兵团四十四团', '兵团四十九团', '兵团五十团', '兵团五十一团', '兵团五十三团', '兵团图木舒克市喀拉拜勒镇', '兵团图木舒克市永安坝',
				'其他'
			],
			'五家渠': ['军垦路街道', '青湖路街道', '人民路街道', '兵团一零一团', '兵团一零二团', '兵团一零三团', '其他']
		},
		'香港': {
			'香港': ['中西区', '东区', '九龙城区', '观塘区', '南区', '深水区', '湾仔区', '黄大仙区', '油尖旺区', '离岛区', '葵青区', '北区', '西贡区', '沙田区', '屯门区',
				'大埔区', '荃湾区', '元朗区', '其他'
			]
		},
		'澳门': {
		...
		'台湾': {
			'台湾': ['台北市', '高雄市', '基隆市', '台中市', '台南市', '新竹市', '嘉义市', '台北县', '宜兰县', '新竹县', '桃园县', '苗栗县', '台中县', '彰化县', '南投县',
				'嘉义县', '云林县', '台南县', '高雄县', '屏东县', '台东县', '花莲县', '澎湖县', '其他'
			]
		}
	}
